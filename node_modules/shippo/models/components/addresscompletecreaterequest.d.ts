...
/** @internal */
export declare const AddressCompleteCreateRequest$inboundSchema: z.ZodMiniType<AddressCompleteCreateRequest, unknown>;
/** @internal */
...
/** @internal */
export declare const AddressCompleteCreateRequest$outboundSchema: z.ZodMiniType<AddressCompleteCreateRequest$Outbound, AddressCompleteCreateRequest>;
export declare function addressCompleteCreateRequestToJSON(addressCompleteCreateRequest: AddressCompleteCreateRequest): string;
export declare function addressCompleteCreateRequestFromJSON(jsonString: string): SafeParseResult<AddressCompleteCreateRequest, SDKValidationError>;
//# sourceMappingURL=addresscompletecreaterequest.d.ts.map