...
import { Cod, Cod$Outbound } from "./cod.js";
import { ParcelInsurance, ParcelInsurance$Outbound } from "./parcelinsurance.js";
/**
...
/** @internal */
export declare const ParcelExtra$inboundSchema: z.ZodMiniType<ParcelExtra, unknown>;
/** @internal */
...
/** @internal */
export declare const ParcelExtra$outboundSchema: z.ZodMiniType<ParcelExtra$Outbound, ParcelExtra>;
export declare function parcelExtraToJSON(parcelExtra: ParcelExtra): string;
export declare function parcelExtraFromJSON(jsonString: string): SafeParseResult<ParcelExtra, SDKValidationError>;
//# sourceMappingURL=parcelextra.d.ts.map