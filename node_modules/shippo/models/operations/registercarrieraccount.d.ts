...
/** @internal */
export type RegisterCarrierAccountRequestBody$Outbound = components.CarrierAccountCanadaPostCreateRequest$Outbound | components.CarrierAccountChronopostCreateRequest$Outbound | components.CarrierAccountColissimoCreateRequest$Outbound | components.CarrierAccountCorreosCreateRequest$Outbound | components.CarrierAccountDeutschePostCreateRequest$Outbound | components.CarrierAccountDHLExpressCreateRequest$Outbound | components.CarrierAccountDpdDeCreateRequest$Outbound | components.CarrierAccountDPDUKCreateRequest$Outbound | components.CarrierAccountFedExCreateRequest$Outbound | components.CarrierAccountHermesUKCreateRequest$Outbound | components.CarrierAccountMondialRelayCreateRequest$Outbound | components.CarrierAccountPosteItalianeCreateRequest$Outbound | components.CarrierAccountUPSCreateRequest$Outbound | components.CarrierAccountUSPSCreateRequest$Outbound | components.CarrierAccountSendleCreateRequest$Outbound;
/** @internal */
export declare const RegisterCarrierAccountRequestBody$outboundSchema: z.ZodMiniType<RegisterCarrierAccountRequestBody$Outbound, RegisterCarrierAccountRequestBody>;
